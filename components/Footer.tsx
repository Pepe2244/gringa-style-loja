        ...
        <footer className="rodape">
            <div className="container">
                ...
                <div className="rodape-coluna">
                    <h4>Contato</h4>
                    <p>
                        <a href="https://wa.me/5515998608170" target="_blank" style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                ...
                <div className="rodape-coluna">
                    <h4>Siga-nos</h4>
                    <a href="https://www.instagram.com/gringastyle_br" target="_blank" className="social-link" style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
